...
public class ExampleUITest {
    ...
    public void test() throws InterruptedException {
        ...
        onView(withId(R.id.lvStations)).check(matches(isDisplayed())).check(matches(hasChildCount(2)));
        elementoLista2 = onData(anything()).inAdapterView(withId(R.id.lvStations)).atPosition(0);
        elementoLista2.onChildView(withId(R.id.tvName)).check(matches(withText("REPSOL")));
        elementoLista3 = onData(anything()).inAdapterView(withId(R.id.lvStations)).atPosition(1);
